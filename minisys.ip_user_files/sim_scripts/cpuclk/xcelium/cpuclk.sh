...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../ipstatic/30ef" +incdir+"../../../ipstatic/30ef" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/30ef" +incdir+"../../../ipstatic/30ef" \
