...
#
# Script generated by Vivado on Wed Jul 05 14:40:39 +0800 2023
...
# script info
echo -e "cpuclk.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic/30ef" +incdir+"../../../ipstatic/30ef" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/30ef" +incdir+"../../../ipstatic/30ef" \
