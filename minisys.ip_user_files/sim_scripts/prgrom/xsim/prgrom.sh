...
#
# Script generated by Vivado on Sat Jul 08 16:54:22 +0800 2023
...
#
# Usage        : prgrom.sh
#                prgrom.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                prgrom.sh [-reset_run]
#                prgrom.sh [-reset_log]
#                prgrom.sh [-help]
#
...
# script info
echo -e "prgrom.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./prgrom.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot prgrom xil_defaultlib.prgrom xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb prgrom.wdb xsim.dir libdpi.so)
...
Usage: prgrom.sh [-step]\n\
Usage: prgrom.sh [-lib_map_path]\n\
Usage: prgrom.sh [-reset_run]\n\
Usage: prgrom.sh [-reset_log]\n\
Usage: prgrom.sh [-keep_index]\n\
