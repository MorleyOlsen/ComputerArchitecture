...
module memorio(
    caddress,address,memread,memwrite,ioread,iowrite,fbwrite,
    mread_data,ioread_data,wdata,rdata,write_data,
    LEDCtrl,SwitchCtrl,VSyncCtrl,BellCtrl
);
	...
	assign  VSyncCtrl = ((iorw==1) && (caddress[31:4] == 28'hFFFFFC8));
    assign  BellCtrl = ((iorw==1) && (caddress[31:4] == 28'hFFFFFC9));
							
    always @* begin
        if(memwrite||iowrite||fbwrite) begin
            write_data = wdata;
        end else begin
